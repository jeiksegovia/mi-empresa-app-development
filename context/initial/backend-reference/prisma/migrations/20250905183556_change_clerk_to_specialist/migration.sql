/*
  ...
  - The values [CLERK] on the enum `UserRoleEnum` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "public"."UserRoleEnum_new" AS ENUM ('ADMINISTRATOR', 'SUPERVISOR', 'USER', 'REQUESTOR', 'SPECIALIST');
